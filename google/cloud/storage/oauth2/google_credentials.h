...
/// Create an authorized user credential. Note that it is strongly preferred to
...
// TODO: Should we support loading service account credentials from a P12 file
// too? Other libraries do, but the JSON format is strongly preferred.
